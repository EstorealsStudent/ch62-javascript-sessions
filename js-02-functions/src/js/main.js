...
console.log( printFullNamea("Johan", "Gonzalez") );
 ...
 */
const printFullNamea = function (firstName, lastName) {
...
const printFullNameFlecha = (firstName, lastName) => `${firstName} ${lastName} estudiante de la Ch62`;

console.log(printFullNameFlecha("Juan", "Pérez")); // Output: Juan Pérez estudiante de la Ch62

// TODO: generar una función que calcule el área de un rectángulo
// usando parámetros por defecto para largo y ancho.
const calcularAreaRectangulo = (largo = 1, ancho = 1) => largo * ancho;
...
console.log( `Hola se está realizando una suma: ${calculate(4,5,suma)}` ); //9

// Aplicar una función que calcule el residuo de una devisión, para saber si 6 es divisible entre 3
const residuo=(a,b)=> a % b;
console.log( `El residuo de 6 dividido entre 3 es: ${calculate(6,3,residuo)}` ); //0
// Ap